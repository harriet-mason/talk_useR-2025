...
![](images/dibble.jpeg){fig-align="center"}
...
## Code to make pixel map {fig-align="center"}
![](images/pixel.jpeg){fig-align="center"}
...
## Can we visualise distribution objects?
- Yay have tidy format for distributions
